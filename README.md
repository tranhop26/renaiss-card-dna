...
## Renaiss OS Index Integration

Renaiss Card DNA includes live **Renaiss OS Index Search** inside the Card DNA Analyzer.

Users can search indexed cards such as `Charizard`, `Zoro`, or `Pikachu`, view real Renaiss OS Index fields such as card image, set, grade, reference price, confidence, and momentum, then generate an experimental Card DNA preview on top of that data.

Data source: **Renaiss OS Index API beta**.

Important note: demo cards still use mock data. DNA scores are generated by Renaiss Card DNA as experimental collector-fit interpretations and are not financial advice.
...
### Renaiss OS Index Search
Search real indexed cards from Renaiss OS Index API beta:
- Search indexed collectible cards such as Charizard, Zoro, or Pikachu
- Display card image, set, grade, reference price, confidence, and momentum
- Generate experimental Card DNA preview from live Index fields
- Show source attribution and Index link clearly
- **Try it:** `/analyzer`
...
### Data Sources
- **Demo Cards**: Mock dataset of sample cards for prototype demonstration
- **Renaiss OS Index Search**: Live Renaiss OS Index API beta for indexed card search, card image, set, grade, reference price, confidence, and momentum signals
- **Transactions**: Synthetic trading history for demo cards
- **Collector Profiles**: Deterministic demo generation based on wallet-like input
...
- Demo cards use mock/synthetic data. Renaiss OS Index Search uses live Renaiss OS Index API beta reference data.
